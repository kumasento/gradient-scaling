...
parser.add_argument('--n_class',
                    type=int,
                    default=10,
                    help='Number of classes (select 10 or 100)')
# AdaLoss parameters
...
parser.add_argument('--update_per_n_iteration',
                    type=int,
                    default=1,
...
def main():
    ...
    fig = utils.plot(
        ...
        ldf,
        title=
        'Train ResNet-{n_layer} on CIFAR-{n_class} by {method} (scale={loss_scale}, seed={manual_seed})'
        .format(n_layer=args.n_layer,
                n_class=args.n_class,
                method=args.method,
