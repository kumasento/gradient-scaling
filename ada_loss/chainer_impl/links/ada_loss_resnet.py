...
class AdaLossBasicBlock(chainer.Chain):
    ...
    def __init__(self,
        ...
        with self.init_scope():
            # pad = dilate
            self.conv1 = AdaLossConv2DBNActiv(in_channels,
                                              out_channels,
                                              stride=1,
                                              **kwargs)
            ...
            kwargs['activ'] = None
            self.conv2 = AdaLossConv2DBNActiv(out_channels,
                                              out_channels,
                                              stride=stride,
            ...
            if residual:
                self.residual = AdaLossConv2DBNActiv(in_channels,
                                                     out_channels,
                                                     ksize=1,
                                                     stride=stride,
                                                     pad=0,
    ...
    def __init__(self,
        ...
        with self.init_scope():
            self.conv1 = AdaLossConv2DBNActiv(in_channels,
                                              ...
                                              stride=stride,
                                              **kwargs)
            self.conv2 = AdaLossConv2DBNActiv(mid_channels,
                                              mid_channels,
                                              ksize=3,
                                              pad=dilate,
                                              dilate=dilate,
                                              ...
                                              stride=1,
                                              **kwargs)
            self.conv3 = AdaLossConv2DBNActiv(mid_channels,
                                              out_channels,
                                              ksize=1,
                                              stride=1,
                                              pad=0,
...
class AdaLossBottleneckBlockv2(chainer.Chain):
    ...
    def __init__(self,
        ...
        with self.init_scope():
            self.conv1 = AdaLossBNActivConv2D(in_channels,
                                              mid_channels,
                                              ksize=1,
                                              pad=0,
                                              stride=stride,
                                              **kwargs)
            self.conv2 = AdaLossBNActivConv2D(mid_channels,
                                              mid_channels,
                                              ksize=3,
                                              pad=dilate,
                                              dilate=dilate,
                                              ...
                                              stride=1,
                                              **kwargs)
            self.conv3 = AdaLossBNActivConv2D(mid_channels,
                                              out_channels,
                                              ksize=1,
                                              stride=1,
                                              pad=0,
            ...
            if residual:
                ...
                self.residual = AdaLossConvolution2D(in_channels, out_channels, ksize=1,
                                                     pad=0, stride=stride, **kwargs)
            else:
                self.residual = IdentityLossScalingWrapper(lambda x: x)
